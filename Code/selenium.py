...
driver = webdriver.Chrome(chrome_options=options, executable_path=r'C:\Users\Abel\Desktop\Abel\chromedriver.exe')
# Abrimos la página
...
target = driver.find_element_by_xpath("//ul/li/a/span[text()='Datos históricos']") 
target.click()
sleep
